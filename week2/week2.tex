...
form, and assign frames for links 0 through 3. This is shown in
Figure 5. Since we are following the DH assumptions,
we must follow the frame assignment style shown in Figure 4, which
is from our textbook~\cite{Spong2006}.\\\\
As shown, frame 0 ($x_0 y_0 z_0$) is assigned at the first joint, frame 1
($x_1 y_1 z_1$) is assigned at the
second joint, and frame 2 ($x_2 y_2 z_2$)
 is assigned at third joint. Frame 3 ($x_3 y_3 z_3$) is assigned at
the end of link 3.\\
