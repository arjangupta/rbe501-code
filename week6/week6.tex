...
is some constant value, and hence tweaking $r$ will cause a compensation in $\dot{\theta}$, and vice-versa.
One fascinating real-life application of the conservation of angular momentum is the spinning of a gyroscope.
Gyroscopes react to external forces by adjusting themselves in a direction that is given by the cross product
...
day sensors, gyroscopic sensors are used to help tell the orientation in something. Specifically, 
